...
function HeroSection() {
  return (
    <section className="relative overflow-hidden pt-16 pb-24 md:pt-24 md:pb-32 bg-alice-blue">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
          
          {/* --- KOLOM KIRI (TEKS & CTA) --- */}
          <div className="md:col-span-7 relative z-10">
            {/* Tagline di atas headline */}
            <p className="text-sm md:text-base font-bold text-safety-orange uppercase tracking-widest mb-3">
              Generasi Biru
            </p>

            {/* Headline Utama (WAH Factor - Tipografi Dramatis) */}
            <h1 className="font-display font-black text-5xl md:text-7xl lg:text-8xl leading-none text-brand-dark">
            ...
            <p className="mt-8 text-lg md:text-xl text-steel-blue max-w-2xl font-medium">
              ...
              Ini bukan cuma tentang bicara, ini tentang bergerak.
            </p>

            {/* Tombol CTA (Mendesak & Fungsional) */}
          ...
          {/* --- KOLOM KANAN (VISUAL ANTI-TEMPLATE) --- */}
          <div className="md:col-span-5 hidden md:block relative z-0">
            {/* Bentuk-bentuk geometris abstrak dari palet warna kita */}
            {/* Ini adalah "Visual-forward" kita tanpa gambar foto */}
            <div className="relative w-full h-96 xl:h-[500px] rounded-3xl overflow-hidden shadow-2xl">
              ...
              {/* Icon besar sebagai visual point */}
